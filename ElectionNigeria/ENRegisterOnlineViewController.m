//
// Class:    ENRegisterOnlineViewController
//
...
#import "ENRegisterOnlineViewController.h"
...
@interface ENRegisterOnlineViewController ()<UITextFieldDelegate, UIGestureRecognizerDelegate, UIActionSheetDelegate, UINavigationControllerDelegate, UIImagePickerControllerDelegate, UIPopoverControllerDelegate>
{
...
@implementation ENRegisterOnlineViewController
...
- (void)viewDidLayoutSubviews
{
    ...
    [self.scrollView setContentSize:CGSizeMake(_scrollView.frame.size.width, _signatureButton.frame.origin.y + CGRectGetHeight( _signatureButton.frame) + SPACING)];
}
